...
!function ($) {
    ...
    Dropdown.prototype = {
        ...
        , change: function (e) {
            ...
            if (!$toggle || !$toggle.length) {
                $toggle = $menu.parent().parent().parent().find(toggle);
            }
    ...
    $(document)
        ...
        .on('change.dropdown-menu', '.dropdown-menu > li > input[type="checkbox"], .dropdown-menu > li > input[type="radio"], .dropdown-menu > li.dropdown-submenu > ul > li > input[type="radio"]', Dropdown.prototype.change)
